...
<body>
<div id="registerPanel" class="inputPanel" style="margin-top: 0.5em">
    <iframe name='frameFile' style='display: none;'></iframe>
    <form action="#" method="POST" target="frameFile">
        <div id="registerTop" class="panelTop">
            <p>Register</p><button class="">×</button>
        </div>
        <p class="inputGroup">
            Username<br>
            <input type="text" name="username" id="username" onchange="username_check()"><span id = "username_check">Username Required</span>
        </p>
        <p class="inputGroup">
            Password<br>
            <input type="password" name="password" id="password" onchange="password_check();password_confirm_check()"><span id = "password_check">Password Required</span>
        </p>


        <p class="inputGroup">
            Confirm your Password<br>
            <input type="password" name="password_confirm" id="password_confirm" onchange="password_confirm_check()"><span id = "password_confirm_check">Password Required</span>
        </p>
        <p class="inputGroup">
            Address<br>
            <select name="area">
        ...
        <p class="inputGroup">
            Telephone Number<br>
            <input type="tel" name="telephone" id = "telephone" onchange="register_telephone_check()"><span id = "telephone_check">Telephone Number Required</span>
        </p>
